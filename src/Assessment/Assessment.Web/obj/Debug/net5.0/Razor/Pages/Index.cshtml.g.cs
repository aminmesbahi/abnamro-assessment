#pragma checksum "D:\src\ABN Amro\Assessment\src\Assessment\Assessment.Web\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9ed37c52f210ec5d6ca14404acf572e49a61683b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9ed37c52f210ec5d6ca14404acf572e49a61683b", @"/Pages/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9ed37c52f210ec5d6ca14404acf572e49a61683b7601", async() => {
                WriteLiteral(@"
      <div class=""mb-1"">
        ...
        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("button", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9ed37c52f210ec5d6ca14404acf572e49a61683b8424", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9ed37c52f210ec5d6ca14404acf572e49a61683b12037", async() => {
                WriteLiteral(@"
      <div class=""mb-1"">
      ...
      ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("button", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9ed37c52f210ec5d6ca14404acf572e49a61683b12750", async() => {
...
<script>
  $(function () {
    ...
    $('#btnGetStatus').on('click', function (evt) {
      ...
      let normIcon = '<i class=""bi bi-calculator bi-spin""></i>';
");
                WriteLiteral(@"      $.post('/?handler=GetStatus', $('#statusInquiryForm').serialize(), function () {
        $(""#btnStartCalculation"").html(calcIcon);
        $(""#btnStartCalculation"").attr(""disabled"", 'disabled');
      }).done(function (data) {
  ...
  var seconds = Math.round(timeDiff);
        $(""#getStatusResult"").html(`Progress: ${jsonData.progress}% <br> State: ${jsonData.state} <br> Result: ${((jsonData.result == -1) ? 'Not Ready Yet!' : jsonData.result)} <br> <span class=""text-black-50 fs-6""><i class=""bi bi-stopwatch""></i> ${((jsonData.result == -1) ? 'Elapsed Time: '+ seconds +' seconds' : 'Total Time: '+ (jsonData.result - inputV");
                WriteLiteral("al) +\' seconds\')}</span>`);\r\n        console.log(jsonData);\r\n      });\r\n    });\r\n  });\r\n</script>\r\n");
            }
            );
        }
